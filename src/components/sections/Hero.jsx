    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-slate-800/50 backdrop-blur p-6 rounded-xl border border-slate-700">
          <div className="text-cyan-400 font-heading text-3xl font-bold mb-2">2,880x</div>
          <div className="font-subheading text-xl">Faster risk updates than competitors</div>
        </div>
        <div className="bg-slate-800/50 backdrop-blur p-6 rounded-xl border border-slate-700">
          <div className="text-cyan-400 font-heading text-3xl font-bold mb-2">&gt;95%</div>
          <div className="font-subheading text-xl">Claims accuracy rate</div>
        </div>
        <div className="bg-slate-800/50 backdrop-blur p-6 rounded-xl border border-slate-700">
          <div className="text-cyan-400 font-heading text-3xl font-bold mb-2">24/7</div>
          <div className="font-subheading text-xl">Real-time monitoring</div>
        </div>
      </div>
    </div>
  </section>
